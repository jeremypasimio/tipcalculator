...
const partners = ['Isaac','Ashley','Bethany', 'Joey', 'Cheryl', 'Tasha', 'Jenny','Diego','Tabby','Elliot', 'Brian', 'Valerie','Delaney','Avi', 'Jeremy', 'Mekhi', 'Codi', 'Reese','Autumn', 'Bella', 'Camden', 'Grace', 'Britney'];
